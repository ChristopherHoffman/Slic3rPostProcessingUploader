...
{
    internal class FLSunParser : IGcodeParser
    {
        private readonly string noteTemplate;

        public FLSunParser(string noteTemplate)
        {
            if (string.IsNullOrEmpty(noteTemplate))
            {
                var defaultTemplate = new FLSunDefaultNoteTemplate();
        ...
        private string RenderNoteTemplate(string gcode)
        {
            ...
            if (matches != null)
            {
                foreach (Match match in matches)
                {
                    ...
                    // Convert into FLSun-slicers format
