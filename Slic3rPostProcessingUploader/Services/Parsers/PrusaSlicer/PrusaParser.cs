...
namespace Slic3rPostProcessingUploader.Services.Parsers.PrusaSlicer
{
    internal class PrusaParser: IGcodeParser
    {
        ...
        public PrusaParser(string noteTemplate)
        {
            ...
            {
                var defaultTemplate = new PrusaDefaultNoteTemplate();
        ...
        {
            // ; generated by PrusaSlicer 2.8.0+win64 on 2024-11-17 at 00:18:51 UTC

            var printTimeStringMatch = Regex.Match(gcode, @"generated by PrusaSlicer (.+) on", RegexOptions.IgnoreCase | RegexOptions.Multiline);
